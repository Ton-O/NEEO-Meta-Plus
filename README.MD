...
## I've been maintaining a fully working version Docker image, to make reproduction of META much simpler. This image runs perfectly on a X86-based Docker host.
[Docker image](https://hub.docker.com/repository/docker/tonot1/neeo-meta-plus/general)
